...
namespace Nomnom.UnityProjectPatcher.AssetRipper {
    ...
    public class AssetRipperSettings : ScriptableObject {
        ...
        public string ExePath => Path.Combine(FolderPath, "AssetRipper.Tools.SystemTester");
        ...
        const string defaultBuildUrl = "https://github.com/nomnomab/AssetRipper/releases/download/v1.0.12-patcher/Linux-Release.zip";
